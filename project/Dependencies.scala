...
object Dependencies {
  object Play {
    ...
    val b3 =   "com.adrianhurt" %% "play-bootstrap" % "1.4-P26-B3-SNAPSHOT"
  ...
  object Database {
    ...
    object Doobie {
      ...
      val h2 = "org.tpolecat" %% "doobie-h2"   % "0.6.0"
    }
  ...
  object WebJars {
    ...
    val jquery = "org.webjars" % "jquery" % "3.3.1-1" intransitive()
    val materialize = "org.webjars" % "materializecss" % "1.0.0" intransitive()
    val swaggerUi = "org.webjars" % "swagger-ui" % "3.19.0" intransitive()
    val bootstrapMaterial = "org.webjars.npm" % "bootstrap-material-design" % "4.1.1" intransitive()
    val mdbbootstrapMaterial = "org.webjars" % "mdbootstrap-bootstrap-material-design" % "4.5.3" intransitive()
    val popperjs =   "org.webjars" % "popper.js" % "1.14.4" intransitive()
...
object Emailer {
  val version = "6.0.1"
  val playMailer ="com.typesafe.play" %% "play-mailer" % version
  val playEmailerGuice = "com.typesafe.play" %% "play-mailer-guice" % version
  val quartz = "com.enragedginger" %% "akka-quartz-scheduler" % "1.6.1-akka-2.5.x"
...
//    val scopts = "com.github.scopt" %% "scopt" % "3.7.0"
    ...
    val bindingScalaVersion="11.1.0"
    val elastic4sVersion = "6.2.3"
    val playcirce = "com.dripower" %% "play-circe" % "2610.0"
    val scribe = "com.outr" %% "scribe" % "2.3.0"
    val fastparser = "com.lihaoyi" %% "fastparse" % "2.0.4"
  }
  ...
  object Elastic4s {
    val elastic4score = "com.sksamuel.elastic4s" %% "elastic4s-core" % Utils.elastic4sVersion
    val elastic4shttp = "com.sksamuel.elastic4s" %% "elastic4s-http" % Utils.elastic4sVersion
    val elastic4sstream = "com.sksamuel.elastic4s" %% "elastic4s-http-streams" % Utils.elastic4sVersion
    val elastic4scirce = "com.sksamuel.elastic4s" % "elastic4s-circe_2.12" % Utils.elastic4sVersion
  }
}
