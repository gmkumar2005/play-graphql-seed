...
object Server {
  private[this] val dependencies = {
    ...
    Seq(
      ...
      Akka.testkit, Play.test,Play.webJars, Testing.scalaTest, Emailer.playEmailerGuice,Emailer.playMailer,Play.ficus,Emailer.quartz, 
      Play.b3
    )
  }
  ...
  private[this] lazy val serverSettings = Shared.commonSettings ++ Seq(
    ...
    maintainer := "GraphQL User <admin@github.com>",
...
//    RoutesKeys.routesImport ++= Seq(".QueryStringUtils._", "util.web.ModelBindables._"),
    ...
    // Source Control
    scmInfo := Some(ScmInfo(url("https://github.com/gmkumar2005/play-graphql-seed"), "git@github.com:gmkumar2005/play-graphql-seed.git")),
